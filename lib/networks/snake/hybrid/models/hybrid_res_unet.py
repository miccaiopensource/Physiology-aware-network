...
def ResUNet18_Double_Skip(in_channels=1, out_channels=3, n_slices=15, input_size=96, p=0.0):
    return ResUNet_Double_Skip(in_channels=in_channels, out_channels=out_channels, n_slices=n_slices, input_size=input_size,
