...
class Annotation():
    ...
    def __init__(self,txt_dir, config_num, metric_prev_epoch = None, phases_prev_epoch = None, transform = None, mode = 'train',
        ...
        """
        self.data_dir = "/data/ugui0/antonio-t/CPR_multiview_interp2_huang/"
        ...
        self.label_dir = os.path.join("/data/ugui0/antonio-t/CPR_multiview_interp2_huang/", "annotations")
    ...
    def save_annotations(self,ann, path):
        ...
        instance_path = os.path.join(path, "medical_{}_instance_noncal_{}.json".format("val" if self.mode == 'test' else self.mode,self.config_num))
...
if __name__ == '__main__':
    ...
    #
    #
    text_dir = "configs/configs_all/config_all3"
    mode = 'train'
    print("start config_all3_noncal")
    ann = Annotation(text_dir,3, metric_prev_epoch, phases_prev_epoch, compose[mode], mode,
                     is_hard_mining, cfg.percentile, cfg.multi_view, cfg.interval, cfg.down_sample,
                     args.config, split)
    ann.convert_sbd()
